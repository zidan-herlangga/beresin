            ...
            {categories.map((cat, i) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
                  <div
                    className={`w-14 h-14 rounded-2xl ${cat.bg} flex items-center justify-center text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform shrink-0`}
                  >
                    {cat.icon}
                  </div>
                ...
                <div
                  className={`mt-4 h-0.5 w-0 group-hover:w-full transition-all duration-500 bg-gradient-to-r ${cat.gradient} rounded-full`}
                />
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-3 text-indigo-200">
            Gratis! Chat aja, kita jelasin detailnya.
          </p>
          <a
            href="/kontak"
