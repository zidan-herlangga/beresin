    ...
    <div className="pt-20">
      <section className="relative py-24 overflow-hidden bg-gradient-to-b from-indigo-50/50 to-white dark:from-gray-950 dark:to-gray-950">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            Dari konsultasi sampai tugas beres — semua lewat WhatsApp, gampang & cepat.
          </p>
        </div>
      </section>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    <div className={`sm:hidden w-8 h-8 rounded-lg bg-gradient-to-br ${s.gradient} flex items-center justify-center text-white text-xs font-bold`}>
                      {s.num}
                    </div>
                  ...
                  <div className={`mt-3 h-0.5 w-0 group-hover:w-20 transition-all duration-500 bg-gradient-to-r ${s.gradient} rounded-full`} />
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-3 text-indigo-200">Gratis konsultasi, no obligated.</p>
          <a
            href="/kontak"
