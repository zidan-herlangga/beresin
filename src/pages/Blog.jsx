  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-28 pb-16 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ref={ref}
          className={`max-w-xl mb-12 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
        >
          ...
          <p className="mt-3 text-base text-gray-500 dark:text-gray-400">
            Kumpulan artikel & tips seputar tugas sekolah, kuliah, dan
            produktivitas.
          </p>
        </div>
