...
const sosmed = [
  {
    name: 'Instagram',
    icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h-2v-6h2v6zm-1-7h-.01V8H10v2z',
  },
  {
    name: 'Facebook',
  ...
  {
    name: 'TikTok',
    icon: 'M16.6 5.82s.51.5 0 0A4.28 4.28 0 0115.54 3h-3.09v12.4a2.59 2.59 0 01-2.59 2.5c-1.42 0-2.6-1.16-2.6-2.6 0-1.72 1.66-3.01 3.37-2.48V9.66c-3.45-.46-6.47 2.22-6.47 5.71 0 3.25 2.67 5.89 5.94 5.89 3.43 0 6.32-2.88 6.32-6.32V9.28c.67.43 1.43.74 2.28.88v-3.1c-.88-.25-1.66-.8-2.28-1.24z',
  },
];
...
const kontakData = [
  { label: '0851-5706-6514', href: 'tel:6285157066514' },
  {
    label: 'zidanherlangga24@gmail.com',
    ...
    <footer className="relative py-16 bg-white dark:bg-gray-950 border-t border-gray-100 dark:border-gray-800/50 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          <div className="sm:col-span-2 lg:col-span-4">
            ...
            <p className="mt-3 text-sm leading-relaxed text-gray-400 dark:text-gray-500 max-w-xs">
              Platform joki tugas sekolah &amp; kuliah terpercaya di Indonesia.
              Tugas beres, nilai aman, hati senang.
            </p>
        ...
        <div className="mt-14 pt-8 border-t border-gray-100 dark:border-gray-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500">
            Dibuat dengan{' '}
            <span className="text-red-400 animate-pulse">&hearts;</span> untuk
            pelajar Indonesia
          </p>
        </div>
      </div>
