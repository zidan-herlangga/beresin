...
const defaultData = {
  beranda: {
    ...
    faq: [
      {
        q: 'Apa itu Beresin Tugas?',
        a: 'Beresin Tugas adalah platform jasa bantuan tugas sekolah dan kuliah yang terpercaya.',
      },
      {
        q: 'Bagaimana cara order?',
        a: 'Hubungi kami via WhatsApp, ceritakan tugasmu, kami akan memberikan penawaran.',
      },
      {
        q: 'Apakah data saya aman?',
        a: 'Tentu! Identitas dan data pribadimu kami jamin kerahasiaannya.',
      },
      {
        q: 'Berapa lama proses pengerjaan?',
        a: 'Tergantung kompleksitas tugas. Rata-rata 1-3 hari. Tugas mendesak bisa 1 hari.',
      },
      {
        q: 'Apakah bisa revisi?',
        a: 'Bisa! Setiap paket sudah termasuk revisi. Kami pastikan kamu puas.',
      },
    ],
    blog: [
      {
  ...
  kontak: {
    contacts: [
      ...
      },
      {
        label: 'Instagram',
        value: '@beresin',
        href: 'https://instagram.com/beresin',
        icon: 'ig',
      },
    ],
    socials: [
